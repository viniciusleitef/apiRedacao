...
- Lembre-se que é muito difícil que um texto receba nota 80 ou menos nessa competência, pontue 80 ou menos apenas se o texto apresentar excessivos erros de escrita e a sua compreensão esteja realmente muito comprometida.
- Se o texto for incompreensível, obviamente pontue 0 nessa competência.
"""
    return prompt
